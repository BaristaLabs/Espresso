namespace BaristaLabs.Espresso.Common
{
    ...
    public class Cookie : ICookie
    {
        ...
        public Cookie(string name, string value, bool httpOnly)
        ...
        public Cookie(string name, string value, bool httpOnly, bool secure)
        ...
        /// <param name="secure">Whether the cookie is secure (i.e. HTTPS only).</param>
        /// <param name="expires">The expiration date of the cookie. Can be <see langword="null" /> if it should expire at the end of the session.</param>
        public Cookie(string name, string value, bool httpOnly, bool secure, DateTime? expires)
        {
            this.Name = name;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.AppendFormat("{0}={1}; path={2}", this.Name, this.Value, Path ?? "/");
