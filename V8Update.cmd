...
:EchoUsage
echo Downloads, builds, and imports V8 for use with Espresso.
echo.
...
echo             * Examples: "candidate", "4.2.77.18".
...
echo *** WARNING: THIS V8 REVISION MAY NOT BE COMPATIBLE WITH ESPRESSO ***
choice /m Continue
if errorlevel 2 goto Exit
goto ResolveRevDone
:UseTestedRev
