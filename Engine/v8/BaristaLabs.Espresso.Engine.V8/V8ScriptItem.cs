...
namespace BaristaLabs.Espresso.Engine.V8
{
    ...
    internal class V8ScriptItem : ScriptItem, IDisposable
    {
        ...
        protected override bool TryBindAndInvoke(DynamicMetaObjectBinder binder, object[] args, out object result)
        {
            ...
            catch (Exception exception)
            {
                if (engine.CurrentScriptFrame != null)
                {
                    ...
                    {
                        //FIXME: ErrorCode 1 might not be appropriate.
                        engine.CurrentScriptFrame.ScriptError = new ScriptEngineException(engine.Name, exception.Message, null, 1, false, exception);
                    }
                }
            }
        ...
        public override V8ScriptEngine Engine
        {
            get { return engine; }
        }
